...
export const siteConfig = {
  ...
  description:
    "Hussein Hazime is a full-stack software engineer and website developer building SEO-friendly, high-performance Next.js and React applications for startups and businesses.",
